...
// Local cuid — avoids importing the full @paralleldrive/cuid2 just for this.
function cuid(): string {
  // Prisma's `@default(cuid())` does it server-side; for raw inserts we
  // generate a unique id here. Matches the Prisma cuid format (c + 24 chars).
